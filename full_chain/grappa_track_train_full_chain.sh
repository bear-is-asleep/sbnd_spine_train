#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/full_chain/full_chain_grappa_track.cfg
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/train/full_chain/grappa_track
#cores_per_worker=8
