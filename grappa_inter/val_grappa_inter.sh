#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/grappa_inter/grappa_inter_w_val.cfg
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/val/grappa_inter
#cores_per_worker=8
