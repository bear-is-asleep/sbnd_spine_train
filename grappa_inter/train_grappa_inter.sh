#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/grappa_inter/grappa_inter_w.cfg
LOG_DIR=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/logs/grappa_inter/default
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/train/grappa_inter
#cores_per_worker=8
