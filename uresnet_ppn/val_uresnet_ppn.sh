#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/uresnet_ppn/uresnet_ppn_val.cfg
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/val/uresnet_ppn
#cores_per_worker=8
