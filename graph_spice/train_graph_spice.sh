#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/graph_spice/graph_spice.cfg #Make sure this is the correct config file
LOG_DIR=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/logs/graph_spice/default #Make sure this is the correct log directory
FNAME=/lus/eagle/projects/neutrinoGPU/bearc/simulation/mpvmpr_v02/train/files.txt
PARSL_DIR=/lus/eagle/projects/neutrinoGPU/bearc/sbnd_parsl

workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/train/graph_spice
cores_per_worker=8
