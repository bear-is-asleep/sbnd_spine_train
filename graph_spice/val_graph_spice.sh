#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/graph_spice/graph_spice_val.cfg #Make sure this is the correct config file
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/val/graph_spice
cores_per_worker=8
