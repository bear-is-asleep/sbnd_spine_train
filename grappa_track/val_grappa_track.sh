#!/bin/bash
TRAIN_CFG=/lus/eagle/projects/neutrinoGPU/bearc/spine_train/grappa_track/grappa_track_val.cfg
...
workdir=/lus/eagle/projects/neutrinoGPU/bearc/spine_weights/mpvmpr_v02/val/grappa_track
#cores_per_worker=8
